...
if $SAMLOADER; then
    SAMLOADER_CMDS=(
        ...
        "git apply \"$SRC_DIR/external/patches/samloader/0003-Add-parallel-range-downloads.patch\""
        "git apply \"$SRC_DIR/external/patches/samloader/0004-Add-timeout-to-version.xml-request.patch\""
